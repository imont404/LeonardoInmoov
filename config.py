...
fface1_haar_path = 'haarcascade_frontalface_default.xml'
# frontal face pattern detection
fface2_haar_path = 'haarcascade_frontalface_alt2.xml'
# side face pattern detection
pface1_haar_path = 'haarcascade_profileface.xml'
